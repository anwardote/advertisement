        ...
        <div class="">
                    ...
                    <div class="row">
                        ...
                        @if(isset($androidShowAll) && $androidShowAll==true)
                            <div class="pull-right">
                                ...
                                &nbsp;
                                <a href="{{ route('firmware.category') }}/android" class="btn btn-danger">Show All
                                    Android Firmwares</a>
            ...
            @if(isset($normalShowAll) && $normalShowAll==true)
                <div class="pull-right">
                    <img class="blink" src="/images/hand-indicator.png">
                    &nbsp;
                    <a href="{{ route('firmware.category') }}/normal" class="btn btn-danger">Show All Normal/Smartphone
                        Firmwares</a>
