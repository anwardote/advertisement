...
class DriversController extends Controller
{
    ...
    public function getAdminList(Request $request)
    {
        ...
        if ($user_group === 1 || $user_group === 2 || $user_group === 3) {
            ...
            $results = $this->driverRepository->allUser($request->except(['page']), $user->id);
        }
    ...
    public function getNew(Request $request)
    {
        ...
        return View::make('laravel-authentication-acl::admin.driver.new')->with(['user_data' => $user_group, 'view_category' => $category]);
    }
    ...
    public function getUpdate(Request $request)
    {
        ...
        $category = $this->globalrepository->findcatForFirmware([3, 3]);
        return View::make('laravel-authentication-acl::admin.driver.edit')->with(['user_data' => $user_group,'data' => $result, 'view_category' => $category]);
    }
