...
class ToolsController extends Controller {
    ...
    public function getAdminList(Request $request) {
        ...
        if ($user_group === 1 || $user_group === 2 || $user_group === 3) {
            ...
            $results = $this->toolRepository->allUser($request->except(['page']), $user->id);
        }
    ...
    public function getNew(Request $request) {
        ...
        return View::make('laravel-authentication-acl::admin.tool.new')->with(['user_data' => $user_group, 'view_category'=>$category]);
    }
    ...
    public function getUpdate(Request $request) {
        ...
        return View::make('laravel-authentication-acl::admin.tool.edit')->with(['user_data' => $user_group,'data' => $result, 'view_category'=>$category]);
    }
